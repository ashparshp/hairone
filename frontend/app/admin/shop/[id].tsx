    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        <View>
          ...
          <Text style={[styles.shopAddress, { color: colors.textMuted }]}>
            {shop?.address}
          </Text>
        </View>
        <View
          style={[
            styles.statusBadge,
            {
              backgroundColor: shop?.isDisabled
                ? colors.statusDanger
        ...
        >
          <Text style={styles.statusText}>
            {shop?.isDisabled ? "SUSPENDED" : "ACTIVE"}
          </Text>
        </View>
      </View>
      ...
      <View style={[styles.tabs, { borderColor: colors.border }]}>
        {["overview", "revenue", "bookings"].map((tab) => (
          <TouchableOpacity
            ...
            style={[
              styles.tab,
              activeTab === tab && { borderBottomColor: colors.tint },
            ]}
          ...
          <FadeInView>
            <View style={{ gap: 20 }}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  router.push({
                    pathname: "/salon/manage-gallery",
                    params: { shopId: id },
                  } as any)
                }
              >
                <ImageIcon size={18} color={colors.actionPrimaryText} />
                <Text
                  style={{
              ...
              >
                ...
                <View style={styles.infoRow}>
                  ...
                  <Text style={{ color: colors.text }}>
                    {shop?.bufferTime} mins
                  </Text>
                </View>
                <View style={styles.infoRow}>
                  <Text style={{ color: colors.textMuted }}>Auto Approve</Text>
                  <Text style={{ color: colors.text }}>
                    {shop?.autoApproveBookings ? "Yes" : "No"}
                  </Text>
                </View>
              </View>
            </View>
