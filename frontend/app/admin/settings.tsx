      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        >
          ...
          <View style={styles.inputGroup}>
            ...
            <Text style={[styles.hint, { color: colors.textMuted }]}>
              Taken from the total booking price.
            </Text>
          </View>
        ...
        >
          ...
          <View style={styles.inputGroup}>
            ...
            <Text style={[styles.hint, { color: colors.textMuted }]}>
              Limit per user for cash payments to reduce no-shows.
            </Text>
          </View>
        </View>
        ...
        >
          {saving ? (
            ...
            <>
              <Save size={20} color={colors.actionPrimaryText} />
              <Text
                style={[styles.saveText, { color: colors.actionPrimaryText }]}
              >
                Save Changes
              </Text>
            </>
